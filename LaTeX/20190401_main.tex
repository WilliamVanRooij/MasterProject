...
\begin{figure}
\begin{center}
\includegraphics[width=6in,bb = 0 0 2.5in 0.8in]{images/CorrSingleNoProba.png}
...
\begin{center}
\begin{figure}
\includegraphics[width=3in,bb=0 0 2.5in 2.5in]{images/LD_single.png}
\includegraphics[width=3in,bb=0 0 2.5in 2.5in]{images/LD_multiple.png}
\end{figure}
\end{center}
\begin{center}

\begin{figure}
\includegraphics[width=3in,bb=0 0 2.5in 2.5in]{images/LD_s_anneal.png}
\includegraphics[width=3in,bb=0 0 2.5in 2.5in]{images/LD_m_anneal.png}
\end{figure}
\end{center}
% =========================================
\newpage
